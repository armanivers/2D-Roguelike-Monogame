...
{
    internal class GameOverSuccScreen : MenuScreen
    {
        ...
        public GameOverSuccScreen() : base("You Won!", true, 2, true)
        {
            ...
            quotes = new Dictionary<int, string>()
        {
            ...
            { 1,"Hmm how was it?"},
            { 2,"Never seen a greater warrior!"},
            ...
            gameoverText = new MenuEntry("", false, Color.Black);
